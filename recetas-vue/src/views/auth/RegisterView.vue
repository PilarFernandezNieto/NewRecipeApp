    ...
    <form @submit.prevent="handleSubmit" class="flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-1">
        ...
        <div
          ...
          :class="
            fieldError('name') ? 'border-error' : 'border-outline/40 focus-within:border-primary'
          "
        >
      ...
      <div class="flex flex-col gap-1">
        ...
        <div
          class="flex items-center gap-3 border-b pb-3 transition-colors"
          :class="
            fieldError('email') ? 'border-error' : 'border-outline/40 focus-within:border-primary'
          "
        >
      ...
      <div class="flex flex-col gap-1">
        ...
        <div
          ...
          :class="
            fieldError('password')
              ? 'border-error'
              : 'border-outline/40 focus-within:border-primary'
          "
        >
        ...
        <p v-if="fieldError('password')" class="text-xs text-error mt-1">
          {{ fieldError('password') }}
        </p>
      </div>
